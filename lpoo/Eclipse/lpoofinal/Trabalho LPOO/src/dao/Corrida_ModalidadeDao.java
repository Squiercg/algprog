...
public class Corrida_ModalidadeDao {
	...
	public ArrayList<Integer> findBy_idmodalidade_corridas(int id) throws SQLException{
		ArrayList<Integer> retorno = new ArrayList<Integer>();
		...
		{			
			String corrida_Modalidade[] = new String[3];
			corrida_Modalidade = lista.split(",");				
			retorno.add(Integer.parseInt(corrida_Modalidade[1]));
		}
		
		return retorno;		
	}
	
	public ArrayList<Integer> findBy_idcorrida_modalidades(int id) throws SQLException{
		ArrayList<Integer> retorno = new ArrayList<Integer>();
		...
		{			
			String corrida_Modalidade[] = new String[3];
			corrida_Modalidade = lista.split(",");				
			retorno.add(Integer.parseInt(corrida_Modalidade[0]));
		}
		return retorno;		
	}
	
	public Integer findrelacao_by_corrida_modalidade(int corrida, int modalidade) throws SQLException{
		ArrayList<Integer> retorno = new ArrayList<Integer>();
		
		Map<String, Object> mapping = new HashMap<>();
		mapping.put( "id_corrida",  corrida);
		mapping.put( "id_modalidade",  modalidade);
